...
import com.certora.collect.MapEntry
import datastructures.stdcollections.merge
import datastructures.stdcollections.zip
...
class ArrayHashMapTest: HashMapTest() {
    override fun makeMap(): MutableMap<HashTestObject?, Any?> = ArrayHashMap()
    override fun makeBaseline(): MutableMap<HashTestObject?, Any?> = HashMap()
    override fun makeMap(other: Map<HashTestObject?,Any?>): MutableMap<HashTestObject?, Any?> = ArrayHashMap(other)
    override fun makeBaseline(other: Map<HashTestObject?,Any?>): MutableMap<HashTestObject?, Any?> = HashMap(other)
    override fun makeMapOfInts(): MutableMap<Int?, Int?> = ArrayHashMap()
    override fun makeMapOfInts(other: Map<Int?, Int?>) = ArrayHashMap(other)
    override fun makeBaselineOfInts(): MutableMap<Int?, Int?> = HashMap()
    override fun getBaseDeserializer(): DeserializationStrategy<*> = serializer<HashMap<Int?, Int?>>()
    override fun getDeserializer(): DeserializationStrategy<*> = serializer<ArrayHashMap<Int?, Int?>>()
}

class LinkedArrayHashMapTest: HashMapTest() {
    override fun makeMap(): MutableMap<HashTestObject?, Any?> = LinkedArrayHashMap()
    override fun makeBaseline(): MutableMap<HashTestObject?, Any?> = LinkedHashMap()
    override fun makeMap(other: Map<HashTestObject?,Any?>): MutableMap<HashTestObject?, Any?> = LinkedArrayHashMap(other)
    override fun makeBaseline(other: Map<HashTestObject?,Any?>): MutableMap<HashTestObject?, Any?> = LinkedHashMap(other)
    override fun makeMapOfInts(): MutableMap<Int?, Int?> = LinkedArrayHashMap()
    override fun makeMapOfInts(other: Map<Int?, Int?>) = LinkedArrayHashMap(other)
    override fun makeBaselineOfInts(): MutableMap<Int?, Int?> = LinkedHashMap()
    override fun getBaseDeserializer(): DeserializationStrategy<*> = serializer<LinkedHashMap<Int?, Int?>>()
    override fun getDeserializer(): DeserializationStrategy<*> = serializer<LinkedArrayHashMap<Int?, Int?>>()

    override fun assertIdenticalJson(expected: String, actual: String) {
        assertEquals(expected, actual)
    }

    override fun assertOrderedIteration(expected: Iterator<*>, actual: Iterator<*>) {
        while (true) {
            val eHasNext = expected.hasNext()
            val aHasNext = actual.hasNext()
