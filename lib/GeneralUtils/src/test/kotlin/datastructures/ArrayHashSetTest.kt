...
class ArrayHashSetTest : HashSetTest() {
    override fun makeSet(): MutableSet<HashTestObject?> = ArrayHashSet()
    ...
    override fun makeBaseline(other: Collection<HashTestObject?>): MutableSet<HashTestObject?> =
            HashSet(other)
    override fun getBaseDeserializer(): DeserializationStrategy<*> = serializer<HashSet<HashTestObject?>>()
    override fun getDeserializer(): DeserializationStrategy<*> = serializer<ArrayHashSet<HashTestObject?>>()
}

class LinkedArrayHashSetTest : HashSetTest() {
    override fun makeSet(): MutableSet<HashTestObject?> = LinkedArrayHashSet()
    override fun makeBaseline(): MutableSet<HashTestObject?> = LinkedHashSet()
    override fun makeSet(other: Collection<HashTestObject?>): MutableSet<HashTestObject?> =
            LinkedArrayHashSet(other)
    override fun makeBaseline(other: Collection<HashTestObject?>): MutableSet<HashTestObject?> =
            LinkedHashSet(other)

    override fun getBaseDeserializer(): DeserializationStrategy<*> = serializer<LinkedHashSet<HashTestObject?>>()
    override fun getDeserializer(): DeserializationStrategy<*> = serializer<LinkedArrayHashSet<HashTestObject?>>()
