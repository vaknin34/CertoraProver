...
internal class ArrayHashTable_Capacity32Bits(
    ...
    override fun _computeValueIfAbsent(key: Any?, f: (Any?) -> Any?): Any? = computeValueIfAbsent(key, f)
    override fun _computeValueOrderedIfAbsent(key: Any?, f: (Any?) -> Any?): Any? = computeValueOrderedIfAbsent(key, f)
