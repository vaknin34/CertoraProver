...
Program {
	Block 0_0_0_0_0_0 Succ [] {
		...
		AssumeExpCmd LAnd(Ge(CANON14:12 0x0(int) ) Le(CANON14:12 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON15:13
		AssumeExpCmd LAnd(Ge(CANON15:13 0x0(int) ) Le(CANON15:13 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON29!!2:2
		AssignHavocCmd R3:4
		...
		AssignHavocCmd CANON4:19
		AssumeExpCmd LAnd(Ge(CANON4:19 0x0(int) ) Le(CANON4:19 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON5:20
		AssumeExpCmd LAnd(Ge(CANON5:20 0x0(int) ) Le(CANON5:20 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON6:21
		AssumeExpCmd LAnd(Ge(CANON6:21 0x0(int) ) Le(CANON6:21 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON7:22
		AssumeExpCmd LAnd(Ge(CANON7:22 0x0(int) ) Le(CANON7:22 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON8:23
		AssumeExpCmd LAnd(Ge(CANON8:23 0x0(int) ) Le(CANON8:23 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd CANON9:24
		AssumeExpCmd LAnd(Ge(CANON9:24 0x0(int) ) Le(CANON9:24 0xffffffffffffffffffffffffffffffffffffffff(int) ) )
		AssignHavocCmd R6:7
		...
		AssignExpCmd R7:3 Select(tacExtcodesize!!1:1 Apply(to_skey:bif R6:7) )
		AssumeExpCmd Ge(R7:3 0x1 )
		AssignExpCmd R8:3 Select(tacExtcodesize!!1:1 Apply(to_skey:bif R6:7) )
		...
		AssignExpCmd B10:3 Eq(Select(tacExtcodesize!!1:1 Apply(skey_basic:bif 0x0) ) 0x0 )
		AssumeCmd B10:3
		...
		AnnotationCmd:47 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":19}
		...
		AssignExpCmd:71 I38 CANON14:12
		AssertCmd:72 true "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
		AssignExpCmd:73 R40:3 Apply(hash_3_keccak:bif Apply(skey_basic:bif 0x40) Apply(to_skey:bif Apply(safe_math_narrow_bv256:bif I38)) Apply(skey_basic:bif 0x0))
		AssignExpCmd:74 I41 CANON15:13
		AssertCmd:75 true "sanity bounds check on cvl to vm encoding (unsigned int) of %1$s failed"
		AssignExpCmd:73 R43:3 Mul(0x4 Apply(safe_math_narrow_bv256:bif I41) )
		AssignExpCmd:73 R44:3 Apply(skey_add:bif R40:3 R43:3)
		AssignExpCmd:73 R45:3 Apply(skey_add:bif R44:3 0x1)
		AssignExpCmd:76 I46 CANON15:13
		AssertCmd:77 true "sanity bounds check on cvl to vm encoding (unsigned int) of %1$s failed"
		AssignExpCmd:73 R48:3 Apply(hash_2_keccak:bif Apply(skey_basic:bif 0x20) R45:3)
		AssignExpCmd:73 R49:3 Apply(skey_add:bif R48:3 Apply(safe_math_narrow_bv256:bif I46))
		AssignHavocCmd:73 B50:3
		AssignExpCmd:73 R51:3 Ite(B50:3 0x1 0x0 )
		AssignExpCmd:78 CANON29!!52:25 AnnotationExp(Store(CANON29!!2:2 R49:79 R51:3 ) JSON{"key":{"name":"tac.storage.access-paths","type":"analysis.storage.StorageAnalysisResult$AccessPaths","erasureStrategy":"Canonical"},"value":{"paths":[{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.ArrayAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StaticArrayAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.MapAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.Root","slot":"0"},"key":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I38","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"baseSlot":{"#class":"vc.data.TACSymbol.Const","value":"0"},"hashResult":{"#class":"vc.data.TACSymbol.Const","value":"0"}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Words","numWords":"0"}},"index":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I41","tag":{"#class":"tac.Tag.Int"},"callIndex":0}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Bytes","numBytes":"20"}},"index":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I46","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"baseSlot":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"R48","tag":{"#class":"tac.Tag.UserDefined.UninterpretedSort","name":"skey"},"callIndex":0,"meta":[{"key":{"name":"tac.is-temp-var","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}]}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Bytes","numBytes":"0"}}]}})
		AnnotationCmd:73 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.StorageSnippet.DirectStorageHavoc","value":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"R51","tag":{"#class":"tac.Tag.Bit256"},"callIndex":0,"meta":[{"key":{"name":"tac.is-temp-var","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}]},"displayPath":{"#class":"analysis.storage.DisplayPath.ArrayAccess","index":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I46","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"base":{"#class":"analysis.storage.DisplayPath.FieldAccess","field":"bar","base":{"#class":"analysis.storage.DisplayPath.ArrayAccess","index":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I41","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"base":{"#class":"analysis.storage.DisplayPath.MapAccess","key":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I38","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"keyTyp":{"#class":"tac.TACStorageType.IntegralType","typeLabel":"address","numBytes":"14","descriptor":{"#class":"ReflectivePolymorphicSerializer::spec.cvlast.typedescriptors.EVMTypeDescriptor$address"},"lowerBound":null,"upperBound":null},"base":{"#class":"analysis.storage.DisplayPath.Root","name":"a"}}}}},"storageType":{"#class":"spec.cvlast.typedescriptors.EVMTypeDescriptor.bool"},"contractInstance":"ce4604a0000000000000000000000001","range":{"specFile":"HavocStorage.spec","start":{"line":10,"charByteOffset":10},"end":{"line":10,"charByteOffset":26}}}}
		AssignExpCmd:80 B53 true
		...
		AssignExpCmd:82 I54 CANON14:12
		AssertCmd:83 true "sanity bounds check on cvl to vm encoding (unsigned int elements of a user array) of %1$s failed"
		AssignExpCmd:84 R56:3 Apply(hash_3_keccak:bif Apply(skey_basic:bif 0x40) Apply(to_skey:bif Apply(safe_math_narrow_bv256:bif I54)) Apply(skey_basic:bif 0x0))
		AssignExpCmd:85 I57 CANON15:13
		AssertCmd:86 true "sanity bounds check on cvl to vm encoding (unsigned int) of %1$s failed"
		AssignExpCmd:84 R59:3 Mul(0x4 Apply(safe_math_narrow_bv256:bif I57) )
		AssignExpCmd:84 R60:3 Apply(skey_add:bif R56:3 R59:3)
		AssignExpCmd:84 R61:3 Apply(skey_add:bif R60:3 0x1)
		AssignExpCmd:87 I62 CANON15:13
		AssertCmd:88 true "sanity bounds check on cvl to vm encoding (unsigned int) of %1$s failed"
		AssignExpCmd:84 R64:3 Apply(hash_2_keccak:bif Apply(skey_basic:bif 0x20) R61:3)
		AssignExpCmd:84 R65:3 Apply(skey_add:bif R64:3 Apply(safe_math_narrow_bv256:bif I62))
		AssignExpCmd:89 R66:3 AnnotationExp(Select(CANON29!!52:2 R65:90 ) JSON{"key":{"name":"tac.storage.access-paths","type":"analysis.storage.StorageAnalysisResult$AccessPaths","erasureStrategy":"Canonical"},"value":{"paths":[{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.ArrayAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StaticArrayAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.StructAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.MapAccess","base":{"#class":"analysis.storage.StorageAnalysis.AnalysisPath.Root","slot":"0"},"key":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I54","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"baseSlot":{"#class":"vc.data.TACSymbol.Const","value":"0"},"hashResult":{"#class":"vc.data.TACSymbol.Const","value":"0"}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Words","numWords":"0"}},"index":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I57","tag":{"#class":"tac.Tag.Int"},"callIndex":0}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Bytes","numBytes":"20"}},"index":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I62","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"baseSlot":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"R64","tag":{"#class":"tac.Tag.UserDefined.UninterpretedSort","name":"skey"},"callIndex":0,"meta":[{"key":{"name":"tac.is-temp-var","type":"tac.MetaMap$Companion$NothingValue","erasureStrategy":"Canonical"},"value":{}}]}},"offset":{"#class":"analysis.storage.StorageAnalysis.Offset.Bytes","numBytes":"0"}}]}})
		AssignExpCmd:84 B68 LNot(Eq(R66:3 0x0 ) )
		AnnotationCmd:84 JSON{"key":{"name":"snippet.cmd","type":"vc.data.SnippetCmd","erasureStrategy":"CallTrace"},"value":{"#class":"vc.data.SnippetCmd.EVMSnippetCmd.StorageSnippet.DirectStorageLoad","value":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"B68","tag":{"#class":"tac.Tag.Bool"},"callIndex":0},"displayPath":{"#class":"analysis.storage.DisplayPath.ArrayAccess","index":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I62","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"base":{"#class":"analysis.storage.DisplayPath.FieldAccess","field":"bar","base":{"#class":"analysis.storage.DisplayPath.ArrayAccess","index":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I57","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"base":{"#class":"analysis.storage.DisplayPath.MapAccess","key":{"#class":"vc.data.TACSymbol.Var.Full","namePrefix":"I54","tag":{"#class":"tac.Tag.Int"},"callIndex":0},"keyTyp":{"#class":"tac.TACStorageType.IntegralType","typeLabel":"address","numBytes":"14","descriptor":{"#class":"ReflectivePolymorphicSerializer::spec.cvlast.typedescriptors.EVMTypeDescriptor$address"},"lowerBound":null,"upperBound":null},"base":{"#class":"analysis.storage.DisplayPath.Root","name":"a"}}}}},"storageType":{"#class":"spec.cvlast.typedescriptors.EVMTypeDescriptor.bool"},"contractInstance":"ce4604a0000000000000000000000001","range":{"specFile":"HavocStorage.spec","start":{"line":12,"charByteOffset":11},"end":{"line":12,"charByteOffset":27}}}}
		AssertCmd:91 B68 "\"should fail (value has been havoced and can change)\""
	}
}
Axioms {
}
