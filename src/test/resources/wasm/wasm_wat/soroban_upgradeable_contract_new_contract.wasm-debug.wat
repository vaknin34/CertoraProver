(module $soroban_upgradeable_contract_new_contract.wasm
  ...
  (func $_ZN60_$LT$U$u20$as$u20$soroban_sdk..env..IntoVal$LT$E$C$T$GT$$GT$8into_val17hd4020127ad5cfb78E (type $t3) (result i64)
  ...
  (func $init (type $t2) (param $p0 i64) (result i64)
    ...
    block  ;; label = @1
      ...
      local.set $l1
      block  ;; label = @2
        call $_ZN60_$LT$U$u20$as$u20$soroban_sdk..env..IntoVal$LT$E$C$T$GT$$GT$8into_val17hd4020127ad5cfb78E
  ...
  (func $new_v2_fn (type $t3) (result i64)
    i64.const 4338350760656900)
  ...
  (export "new_v2_fn" (func $new_v2_fn))
